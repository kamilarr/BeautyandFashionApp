...
fun SkinAnalysisStep7(navController: NavController) {
    Scaffold(
        ...
        Column(
            ...
            options.forEach { text ->
                Button(
                    onClick = { navController.navigate("skinResult") },
                    colors = ButtonDefaults.buttonColors(containerColor = BrownDark.copy(alpha = 0.4f)),
                    shape = RoundedCornerShape(16.dp),
                    modifier = Modifier
                        .fillMaxWidth()
...
@Composable
fun SkinAnalysisResult(navController: NavController){
    Scaffold(
        topBar = {
            AppTopBar(
                title = "Skin Type Analysis",
        ...
        Column(
            ...
            Text(
                text = "Hasil Analisis Kulit Kamu",
                fontSize = 20.sp,
            ...
            Image(
                ...
                contentDescription = "Ilustrasi Kulit Normal",
                modifier = Modifier
                    .size(200.dp)
                    .padding(top = 8.dp)
            )
            ...
            Text(
                text = "Tipe kulitmu normal tanpa masalah kulit berarti nih. " +
                        "Good news, kamu bisa mencoba berbagai macam skincare dan makeup tanpa perlu khawatir akan efek samping. " +
                        "Tapii, jangan lupa untuk selalu merawat kulit dengan hidrasi yang cukup, " +
                        "serta gunakan makeup base yang non-comedogenic yaa!",
                fontSize = 16.sp,
